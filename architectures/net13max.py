...
class Net13Max(nn.Module):
    def __init__(self, numberFeatures):
        ...
        self.l1 = LayerBlock(1, numberFeatures, 3, True)    # 13 -> 9
        self.l2 = LayerBlock(numberFeatures, numberFeatures, 3, True)   # 9 -> 5
        self.l3 = nn.Conv2d(numberFeatures, 1, kernel_size=3, padding="valid", stride=(1, 1))
        self.l4 = nn.MaxPool2d(kernel_size=3, stride=(1, 1))
