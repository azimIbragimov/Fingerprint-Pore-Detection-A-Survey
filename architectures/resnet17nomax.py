...
class ResNet17NoMax(nn.Module):
    def __init__(self, numberFeatures):
        super(ResNet17NoMax, self).__init__()
        self.l1 = LayerBlock(1, numberFeatures, 3, False)   #17->15
        self.l2 = LayerBlock(numberFeatures, numberFeatures, 3, False)  #15->13
        self.l3 = LayerBlock(numberFeatures, numberFeatures, 3, False)  #13->11
        self.l4 = LayerBlock(numberFeatures, numberFeatures, 3, False)  #11->9
        self.l5 = LayerBlock(numberFeatures, numberFeatures, 3, False)  #9->7
        self.l6 = LayerBlock(numberFeatures, numberFeatures, 3, False)  #7->5
        self.l7 = LayerBlock(numberFeatures, numberFeatures, 3, False)  #5->3
        self.l8 = nn.Conv2d(numberFeatures, 1, kernel_size=3, padding="valid", stride=(1, 1))
