...
class ResNet19Max(nn.Module):
    def __init__(self, numberFeatures):
        super(ResNet19Max, self).__init__()
        self.l1 = LayerBlock(1, numberFeatures, 3, True)    #19->15
        self.l2 = LayerBlock(numberFeatures, numberFeatures, 3, True)   #15->11
        self.l3 = LayerBlock(numberFeatures, numberFeatures, 3, True)   #11->7
        self.l4 = LayerBlock(numberFeatures, numberFeatures, 3, True)   #7->3
        self.l5 = nn.Conv2d(numberFeatures, 1, kernel_size=3, padding="valid", stride=(1, 1))
        self.l6 = nn.MaxPool2d(kernel_size=1, stride=(1, 1))               
